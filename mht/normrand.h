 ...
 * CONTENTS:                                                         *
 *                                                                   *
 *   Declarations for normal-distribution random number generator.   *
 *                                                                   *
 *   SNormRand( int seed )                                           *
 *     This seeds the random number generator (just calls the        *
 *     standard srand48() routine).                                  *
 *                                                                   *
 *   double NormRand()                                               *
 *     Returns a floating-point random number.  The distribution has *
